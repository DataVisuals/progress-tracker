...
const BUILD_TIMESTAMP = '2025-12-23 13:36:02';
...
import { checkNeedsRecoveryPlan } from './utils/metricHelpers';
...
function App() {
  ...
  const needsRecoveryPlan = useMemo(() => {
    return checkNeedsRecoveryPlan(projectData, projectMetrics, projectRecoveryPlans);
        ...
        {selectedProject && (
          <div className="report-section">
            <ProjectHeader
              ...
              projectRecoveryPlans={projectRecoveryPlans}
              projectLinks={projectLinks}
              editingProjectName={editingProjectName}
              editProjectNameValue={editProjectNameValue}
              setEditProjectNameValue={setEditProjectNameValue}
              editingPortfolio={editingPortfolio}
              editPortfolioValue={editPortfolioValue}
              portfolios={portfolios}
              editingProjectDates={editingProjectDates}
              editProjectStartDate={editProjectStartDate}
              editProjectEndDate={editProjectEndDate}
              setEditProjectStartDate={setEditProjectStartDate}
              setEditProjectEndDate={setEditProjectEndDate}
              setEditingProjectDates={setEditingProjectDates}
              editingPMs={editingPMs}
              editPMValue={editPMValue}
              editSecondaryPMValue={editSecondaryPMValue}
              setEditPMValue={setEditPMValue}
              setEditSecondaryPMValue={setEditSecondaryPMValue}
              setEditingPMs={setEditingPMs}
              users={users}
              editingProjectDesc={editingProjectDesc}
              editProjectDescValue={editProjectDescValue}
              setEditProjectDescValue={setEditProjectDescValue}
              handleProjectNameKeyDown={handleProjectNameKeyDown}
              handleSaveProjectName={handleSaveProjectName}
              handleProjectNameDoubleClick={handleProjectNameDoubleClick}
              handlePortfolioClick={handlePortfolioClick}
              handlePortfolioOptionClick={handlePortfolioOptionClick}
              ...
              setShowLinksEditor={setShowLinksEditor}
              handleNavigateToProject={handleNavigateToProject}
              canEdit={canEdit}
              calculateHealthScore={calculateHealthScore}
              isProjectFieldChanged={isProjectFieldChanged}
              hasProjectDateMoved={hasProjectDateMoved}
              getProjectDateMoveInfo={getProjectDateMoveInfo}
              selectedProject={selectedProject}
            ...
            {selectedProjectTab === 'commentary' && (
              <ProjectCommentary
                ...
                toggleCommentThread={toggleCommentThread}
                handleCancelReply={handleCancelReply}
                canEdit={canEdit}
                getGroupedComments={getGroupedComments}
              />
            )}
